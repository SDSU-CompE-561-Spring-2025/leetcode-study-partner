...
export default function Footer() {
	return (
		<footer className="fixed bottom-0 left-0 right-0 w-full bg-background border-t text-foreground py-6 z-50">
			<div className="w-full px-4 md:px-8 flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
				...
				<div className="text-sm text-muted-foreground text-center md:text-right">
					...
					<p className="text-xs">v1.0.0 — Last updated May 2025</p>
				</div>
			</div>
		</footer>
	);
